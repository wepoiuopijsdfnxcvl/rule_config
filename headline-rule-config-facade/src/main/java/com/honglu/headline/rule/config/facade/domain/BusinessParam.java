...
public class BusinessParam {
    ...
    public String paramValueTwo;

    public String paramNameTwo;

    public String paramValueThree;

    public String paramNameThree;

    public String paramValueFour;

    public String paramNameFour;

    public String paramValueFive;

    public String paramNameFive;
    ...
    public int getBusinessParamId() {
        return businessParamId;
    }

    public void setBusinessParamId(int businessParamId) {
        this.businessParamId = businessParamId;
    }
